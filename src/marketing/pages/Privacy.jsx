...
const SECTIONS = [
  ...
  },
  {
    ...
    body: [
      ...
      'You can delete your account and all associated data by contacting hello@royalicon.net. We will process deletion requests within 14 days.',
      'You can request a copy of any personal data we hold about you by emailing hello@royalicon.net.',
    ],
  },
  {
    title: 'Cookies',
      ...
      <section className="m-section">
        <div className="m-wrap-sm">
          ...
          <div style={{ borderTop: '1px solid #1A1610', paddingTop: '40px' }}>
            ...
            <a href="mailto:hello@royalicon.net" style={{ fontSize: '14px', color: '#D97757', textDecoration: 'none' }}>
              hello@royalicon.net
            </a>
          </div>
        </div>
