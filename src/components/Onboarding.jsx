          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', marginBottom: '40px' }}>
              {[
                ...
                { id: 'mixed',      emoji: '⚡', title: 'Hybrid',             desc: 'Steady salary, plus side income or business.', defaultMonths: 9 },
              ].map(opt => {
          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', marginBottom: '20px' }}>
              ...
              >
                <span style={{ fontSize: '20px', flexShrink: 0 }} aria-hidden="true">⚡</span>
                <div>
                  <div style={{ fontSize: '14px', fontWeight: 600, color: '#E8E2D5' }}>Hybrid</div>
                  <div style={{ fontSize: '12px', color: '#8B8478' }}>Steady salary, plus side income or business</div>
                </div>
              </button>
            </div>
